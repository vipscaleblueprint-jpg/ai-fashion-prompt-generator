...
import { handleBodyAnalyzerSubmission, MARKETING_CLIENTS_WEBHOOK_URL, updateSheet } from "@/lib/body-analyzer-webhook";
...
export default function BodyAnalyzer() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const out = await handleBodyAnalyzerSubmission(compressed, {
                ...
                <section className="mb-10">
                    <div className="max-w-3xl space-y-3">
                        ...
                        <p className="text-foreground/80 text-lg">
                            Analyze body features and generate detailed descriptions.
                        </p>
                    </div>
                </section>
                        ...
                        {!prompts && (
                            <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
                                ...
                                <p className="text-sm text-foreground/70 mb-4">
                                    Upload a clear body image. Click Analyze to get started.
                                </p>
