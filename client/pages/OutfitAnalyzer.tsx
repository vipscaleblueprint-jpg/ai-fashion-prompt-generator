...
import { handleOutfitAnalyzerSubmission, MARKETING_CLIENTS_WEBHOOK_URL, updateSheet } from "@/lib/outfit-analyzer-webhook";
import { addHistoryEntry } from "@/lib/history";
import { toast } from "sonner";
import { Loader2, X, Shirt } from "lucide-react";
...
export default function OutfitAnalyzer() {
    ...
    const startProgressMessages = () => {
        const messages = [
            "Analyzing outfit details...",
            "Identifying garments and style...",
            "Generating fashion description...",
        ];
        let i = 0;
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const out = await handleOutfitAnalyzerSubmission(compressed, {
                ...
                <section className="mb-10">
                    <div className="max-w-3xl space-y-3">
                        ...
                        <p className="text-foreground/80 text-lg">
                            Analyze outfit details, garments, and style from an image.
                        </p>
                    </div>
                </section>
                        ...
                        {!prompts && (
                            <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
                                ...
                                <p className="text-sm text-foreground/70 mb-4">
                                    Upload a full body or outfit image. Click Analyze to get started.
                                </p>
